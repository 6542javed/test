...
if(isset($_POST['category']) && isset($_POST['title_book']) && isset($_POST['author']) && isset($_FILES['file']))
{
  ...
  if(file_exists($pdfdirectory.$filename_saved_as)){
    ...
    if($connect->query($insert)){
      ...
      exec('gswin32 -dSAFER -dBATCH -dNOPAUSE -sDEVICE=jpeg -g250x350 -sOutputFile='.$directorythumb.$filename_without_extension.'.jpeg ../media/pdf/'.$filename_saved_as_without_extension.'.pdf');
